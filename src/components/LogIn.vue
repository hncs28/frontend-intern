      ...
      async login() {
        try {
          ...
          if (response.data.message === 'Login successful') {
            ...
            window.localStorage.setItem('username',customer.customerName);
            window.localStorage.setItem('customerID',customer.customerID);
            window.localStorage.setItem('customerPhone',customer.customerPhone);
            window.localStorage.setItem('customerEmail',customer.customerEmail);
